...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#F3F3F3" class="table table-striped table-bordered table-hover">  
 ...
 <% 
    ...
    String sql =  "select * from pinglun where pinglunren='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("pinglunren")=="" ||request.getParameter("pinglunren")==null ){}else{sql=sql+" and pinglunren like '%"+request.getParameter("pinglunren")+"%'";}
  ...
  <tr>
    ...
    <td width="150" align="center"><a class="btn btn-warning"  href="pinglun_list2.jsp?scid=<%= map.get("id")%>" onClick="return confirm('真的要删除？')"><i class="glyphicon glyphicon-wrench" > </i>删除</a>
