...
if(request.getParameter("cheliangxinghao")=="" ||request.getParameter("cheliangxinghao")==null ){}else{sql=sql+" and cheliangxinghao like '%"+request.getParameter("cheliangxinghao")+"%'";}
  ...
  %>>
    ...
    <td width="60" height="50" align="center"><!--lianjie1--> <a class="btn btn-info btn-small" href="zijiayoubaoming_detail.jsp?id=<%=map.get("id")%>"> <i class="glyphicon glyphicon-random" > </i> 详细</a> </td>
  </tr>
  	<%
  }
   %>
