...
<form name="form1" id="form1" method="post" action="" style="width:100%">
   搜索:  员工工号：<input name="yuangonggonghao" type="text" id="yuangonggonghao" class="form-control2"  />  员工姓名：<input name="yuangongxingming" type="text" id="yuangongxingming" class="form-control2"  /> 性别：<select name='xingbie' id='xingbie' class="form-control2"><option value="">所有</option><option value="男">男</option><option value="女">女</option></select>  电话：<input name="dianhua" type="text" id="dianhua" class="form-control2"  />
     <input type="submit" name="Submit" value="查找" class='hsgqiehuanshitu' /> <input type="button" name="Submit5" value="切换视图"  class='hsgqiehuanshitu' onClick="javascript:location.href='yuangongxinxilist.jsp';" />
</form>
	...
	i++;
     ...
     %>
                           <td height="316" align="center"><table  height="285" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="250" align="center"><a href="yuangongxinxidetail.jsp?id=<%=map.get("id")%>"><img src="<%=map.get("zhaopian")%>" width="210" height="250" border="0" style="border-radius: 18px;" /></a></td>
                                </tr>
                                <tr>
                                  <td height="26" align="center"><%=map.get("yuangongxingming")%></td>
                                </tr>
                            </table></td>
                            <%
								if (i==4)
