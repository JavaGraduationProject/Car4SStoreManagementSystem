...
function gow()
{
	document.location.href="shangpinleibiexinxi_add.jsp?id=<%=id%>";
}
...
new CommDAO().insert(request,response,"shangpinleibiexinxi",ext,true,false,""); 
...
%>
  ...
  <body >
 <form  action="shangpinleibiexinxi_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  添加商品类别信息:
  <br><br>
