...
<form name="form1" id="form1" method="post" action="" style="width:100%">
   搜索:  商品名称：<input name="shangpinmingcheng" type="text" id="shangpinmingcheng" class="form-control2"  />  商品类别：<%=Info.getselect("shangpinleibie","leibiexinxi","shangpinleibie"," 1=1 ")%>  品牌：<input name="pinpai" type="text" id="pinpai" class="form-control2"  />  所需积分：<input name="suoxujifen1" type="text" id="suoxujifen1"  value='' class="form-control2" />-<input name="suoxujifen2" type="text" id="suoxujifen2"  value='' class="form-control2" />
     <input type="submit" name="Submit" value="查找" class='hsgqiehuanshitu' />   <input type='button' name='Submit5' value='切换视图'  class='hsgqiehuanshitu' onClick="javascript:location.href='jifenshangpinlist.jsp';" /> 
</form>
    ...
    String url = "jifenshangpinlisttp.jsp?1=1"; 
	...
	i++;
     ...
     %>
                           <td height="316" align="center"><table  height="285" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="250" align="center"><a href="jifenshangpindetail.jsp?id=<%=map.get("id")%>"><img src="<%=map.get("tupian")%>" width="210" height="250" border="0" style="border-radius: 18px;" /></a></td>
                                </tr>
                                <tr>
                                  <td height="26" align="left"><p><%=map.get("shangpinmingcheng")%></p>
                                    <p><font color="#FF0000">所需积分:<%=map.get("suoxujifen")%></font></p></td>
                                </tr>
                            </table></td>
                            <%
								if (i==4)
