...
//ext.put("issh","否"); 
new CommDAO().insert(request,response,"xinwentongzhi",ext,true,false,"xinwentongzhi_add2.jsp?lb="+lb); 
%>
<html>
  <head>
...
%>
  <body >
 <form  action="xinwentongzhi_add2.jsp?f=f"  method="post" name="f1"  onsubmit="return checkform();">
  添加<%=lb%>:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" >
    <tr style="display:none"><td>标题：</td><td><input name='biaoti' type='text' id='biaoti' value='1' placeholder="请输入标题" class="form-control" style="width:600px;" /><div style="margin-top:16px;">&nbsp;*</div></td></tr>
	<tr style="display:none"><td>类别：</td>
	  <td><input name="leibie" type="text" id="leibie" value="<%=lb%>" class="form-control">	    <input name="lb" type="hidden" id="lb" value="<%=lb%>">	 
      &nbsp;* </td>
	</tr>
	<tr style="display:none"><td>内容：</td><td><textarea name="neirong" cols="100" rows="8" style="width:700px;height:200px;visibility:hidden;"></textarea></td></tr>
	...
	<tr style="display:none"><td>点击率：</td><td><input name='dianjilv' type='text' id='dianjilv' value='1' class="form-control" /><div style="margin-top:16px;">&nbsp;*</div></td></tr>
    <tr>
      <td height="45">&nbsp;</td>
