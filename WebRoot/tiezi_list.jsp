...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#F3F3F3" class="table table-striped table-bordered table-hover">  
  <tr>
    <td width="84" height="35" align="center" bgcolor='#E6E6E6'>序号</td>
	...
	<!--dpinglun1-->
    <td width="126" align="center" bgcolor='#E6E6E6'>添加时间</td>
    
    <td width="250" align="center" bgcolor='#E6E6E6'>操作</td>
  </tr>
  <% 
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="52" align="center">   <a class="btn btn-info btn-small" href="tiezi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> 
	
	
	<%
	if(map.get("fid").equals("0"))
								{%>
							<a class="btn btn-info btn-small" href="tiezidetail.jsp?id=<%=map.get("id")%>" target="_blank"  >详细</a> 
								<%}
								else
								{%>
<a class="btn btn-info btn-small" href="tiezidetail.jsp?id=<%=map.get("fid")%>"  target="_blank" >详细</a> 
	<%}
	%>
