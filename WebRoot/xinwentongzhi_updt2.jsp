...
new CommDAO().update(request,response,"xinwentongzhi",ext,true,false,"sy.jsp"); 
HashMap mmm = new CommDAO().getmap(id,"xinwentongzhi"); 
%>
  <body >
  <form  action="xinwentongzhi_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="f1"  onsubmit="return checkform();">
