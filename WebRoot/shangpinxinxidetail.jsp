...
<div class="news">
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">
              ...
              <tr>
                  ...
                  <tr>
                    <td width='50%' height="44">￥:<%=mqt.get("xiaoshoujiage")%></td>
                    <td width="16%" align=center>&nbsp;</td>
                </tr>
                  <tr>
                  ...
                  <tr>
                    <td width='50%' height="90"><input type=button name=Submit53 class='hsgqiehuanshitu' value=加入购物车 onClick="javascript:location.href='gouwucheadd.jsp?id=<%=request.getParameter("id")%>';"/>
                      <input type=button name=Submit52 value=收藏 class='hsgqiehuanshitu' onClick="javascript:location.href='jrsc.jsp?id=<%=mqt.get("id")%>&biao=shangpinxinxi&ziduan=shangpinmingcheng';" /></td>
                    <td width="16%" align=center>&nbsp;</td>
                </tr>
                  <tr>
