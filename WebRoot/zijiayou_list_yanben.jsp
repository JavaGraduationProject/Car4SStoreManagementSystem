...
if(request.getParameter("luxianmingcheng")=="" ||request.getParameter("luxianmingcheng")==null ){}else{sql=sql+" and luxianmingcheng like '%"+request.getParameter("luxianmingcheng")+"%'";}
  ...
  %>>
    ...
    <td width="60" height="50" align="center"><!--lianjie1--> <a class="btn btn-info btn-small" href="zijiayoudetail.jsp?id=<%=map.get("id")%>" target="_blank"> <i class="glyphicon glyphicon-random" > </i> 详细</a> </td>
  </tr>
  	<%
  }
   %>
