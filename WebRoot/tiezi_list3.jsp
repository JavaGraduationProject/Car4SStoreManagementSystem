...
<!--hxsglxiangdxongjxs-->
  ...
  <tr>
    <td width="24" align="center" bgcolor='#E6E6E6'>序号</td>
    ...
    <td width="132" align="center" bgcolor='#E6E6E6'>添加时间</td>
    <td width="100" align="center" bgcolor='#E6E6E6'>操作</td>
  </tr>
 <% 
...
//txixixngdy
    ...
    String url = "tiezi_list3.jsp?1=1"; 
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="140" align="center" bordercolor="1"><%=new CommDAO().gettzs((String)map.get("fid")) %></td>
    <td width="132" align="center"><%=map.get("addtime") %></td>
    <td width="54" align="center">   <a class="btn btn-info btn-small" href="tiezi_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a class="btn btn-info btn-small" href="tiezidetail.jsp?id=<%=map.get("fid")%>" target="_blank">详细</a>  <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
