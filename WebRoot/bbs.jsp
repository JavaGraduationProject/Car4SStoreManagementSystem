	...
	<div class="container">
		...
		<div class="news-list c">
			<ul>
				 ...
				 <table border="0" cellpadding="0" bgcolor="#CCCCCC" cellspacing="1" style="border-collapse: collapse" bordercolor="#FFFFFF" width="98%" align="center" class="newsline">
                           <% 
	...
	i++;
     ...
     %>
                          <tr bgcolor="#E1F3F4" height="60" valign="middle">
                            ...
                            <td width="53%" align="left" bgcolor="#FFFFFF"><a href="bbslist.jsp?bk=<%=map.get("mingcheng") %>">&nbsp;<%=map.get("mingcheng") %>&nbsp;&gt;&gt;</a> </td>
                            <td width="34%" align="left" bgcolor="#FFFFFF">共有
