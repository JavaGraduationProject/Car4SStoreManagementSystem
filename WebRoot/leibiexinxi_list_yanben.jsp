...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="cccccc">  
  <tr>
    ...
    <td width="60" align="center" bgcolor='#E6E6E6'>操作</td>
  </tr>
  <% 
...
if(request.getParameter("shangpinleibie")=="" ||request.getParameter("shangpinleibie")==null ){}else{sql=sql+" and shangpinleibie like '%"+request.getParameter("shangpinleibie")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><!--lianjie1--> <a class="btn btn-info btn-small" href="leibiexinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
