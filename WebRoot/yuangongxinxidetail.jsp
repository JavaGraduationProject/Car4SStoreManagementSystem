...
<div class="news">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>员工工号：</td><td width='39%'><%=mqt.get("yuangonggonghao")%></td><td  rowspan=6 align=center><a href=<%=mqt.get("zhaopian")%> target=_blank><img src=<%=mqt.get("zhaopian")%> width=228 height=215 border=0></a></td></tr><tr>
         <td width='11%' height=44>员工姓名：</td><td width='39%'><%=mqt.get("yuangongxingming")%></td></tr><tr>
         ...
         <td width='11%' height=44>职称：</td><td width='39%'><%=mqt.get("gangwei")%></td></tr><tr>
         ...
         <td width='11%' height=100  >简介：</td><td width='39%' colspan=2 height=100 ><%=mqt.get("jianjie")%></td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
                                  <tr>
                                   ...
                                   <% 
							String sql =  "select * from pinglun where xinwenID='"+id+"' and biao='yuangongxinxi' ";
							...
							int i=0;
							 ...
							 %>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 class='hsgqiehuanshitu' onClick="javascript:history.back()" /><!--jixaaxnnxiu-->
<input type=button name=Submit53 value=评论 class='hsgqiehuanshitu' onClick="javascript:hsgpinglun('yuangongxinxi','<%=id%>')"/>
</td></tr>
  </table>	
					</div>
			</ul>
