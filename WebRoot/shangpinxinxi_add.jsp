 ...
 <form  action="shangpinxinxi_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" >
		...
		<tr><td  width="200">销售价格：</td><td><input name='xiaoshoujiage' type='text' id='xiaoshoujiage' value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabelxiaoshoujiage' /></td></tr>
...
return false;
	...
	var xiaoshoujiageobj = document.getElementById("xiaoshoujiage"); if(xiaoshoujiageobj.value==""){document.getElementById("clabelxiaoshoujiage").innerHTML="&nbsp;&nbsp;<font color=red>请输入销售价格</font>";return false;}else{document.getElementById("clabelxiaoshoujiage").innerHTML="  "; } 
