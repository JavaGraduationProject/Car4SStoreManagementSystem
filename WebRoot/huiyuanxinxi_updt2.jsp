...
%>
  ...
  <%
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#cccccc" >  
     ...
     <tr><td>用户名：</td><td><input name='yonghuming' type='text' id='yonghuming' readonly="readonly"  value='<%= mmm.get("yonghuming")%>' class="form-control" /></td></tr>
     ...
     <tr><td>积分：</td><td><input name='jifen' type='text' id='jifen' readonly="readonly" value='<%= mmm.get("jifen")%>' class="form-control" /></td></tr>
