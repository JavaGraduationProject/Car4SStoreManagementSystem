...
if (request.getParameter("jifen2")==""  ||request.getParameter("jifen2")==null ) {}else {sql=sql+" and jifen <= '"+request.getParameter("jifen2")+"'";}
  ...
  %>>
    ...
    <td width="60" height="50" align="center"><!--lianjie1--> <a class="btn btn-info btn-small" href="huiyuanxinxi_detail.jsp?id=<%=map.get("id")%>"> <i class="glyphicon glyphicon-random" > </i> 详细</a> </td>
  </tr>
  	<%
  }
   %>
