...
a http-equiv="Content-Type" content="text/html; charset=gb2312"><style type="text/css">
<!--
body,td,th {
	font-size: 12px;
}
...
<table width="100%" height="193" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#D9E9FF" style="border-collapse:collapse">  
  <TBODY>
    <TR 
  align=middle bgColor=#ffffff>
      <td colspan="2" bgColor=#CADCEA><strong>杭州4s店管理系统</strong></td>
    </TR>
    <TR   align=middle 
  bgColor=#ffffff>
      <TD width="10%" align="left" >系统作者：</TD>
      <TD width="41%"  align="left" ><font class="t4">李佳雨马雯璐</font></TD>
    </TR>
    <TR   align=middle 
  bgColor=#ffffff>
  ...
  bgColor=#ffffff>
      ...
      <TD  align="left" ><font class="t41">18935322802</font></TD>
    </TR>
  </TBODY>
</TABLE>
<p>&nbsp;</p>
