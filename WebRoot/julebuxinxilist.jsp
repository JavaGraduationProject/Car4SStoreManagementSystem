...
<div class="news">
 ...
 <form name="form1" id="form1" method="post" action="" style="width:100%">
   ...
   <input type="submit" name="Submit" value="查找" class='hsgqiehuanshitu' />  <input type='button' name='Submit5' value='切换视图'  class='hsgqiehuanshitu' onClick="javascript:location.href='julebuxinxilisttp.jsp';" /> 
</form>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">  
  <tr>
    <td width="30" align="center" bgcolor="CCFFFF">序号</td>
    <td bgcolor='#CCFFFF'>俱乐部名称</td>
    <td bgcolor='#CCFFFF'>创办人</td>
    <td bgcolor='#CCFFFF' width='65' align='center'>创办时间</td>
    <td bgcolor='#CCFFFF'>联系电话</td>
    <td bgcolor='#CCFFFF'>车友人数</td>
    <td bgcolor='#CCFFFF'>地点</td>
    <td bgcolor='#CCFFFF' width='90' align='center'>车队LOGO</td>
...
if(request.getParameter("didian")=="" ||request.getParameter("didian")==null ){}else{sql=sql+" and didian like '%"+request.getParameter("didian")+"%'";}
  ...
  <tr>
    ...
    <td width="50" align="center"> <a class="btn btn-info btn-small" href="julebuxinxidetail.jsp?id=<%=map.get("id")%>" >详细</a></td>
  </tr>
  	<%
  }
   %>
